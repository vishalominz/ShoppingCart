	...
	<div class="col-md-8" id="cartContent">
		...
		<cfloop from="1" to="#arrayLen(cartItems.data)#" index="location">
			...
			<div class="productItem" id="#CartItems.data[location].productId#">
					<img class="productImage" src="\assets\#cartItems.data[location].productImageLocation#" />
					...
					<input class="productCount img-responsive" type="number" value="#CartItems.data[location].productCount#" maxlength="#CartItems.data[location].maxCount#" />
